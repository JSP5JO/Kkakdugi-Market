...
<%@ include file="../header.jsp"%>
	<div class="mypage">
		<p><span><i class="far fa-user"></i>&nbsp;<strong>${userId}</strong> 님의 Mypage</span><span class="pronum"><strong>나의 전문가번호</strong> : <c:forEach var="pr" items="${ulist}">${pr.proIdx}(${pr.name})</c:forEach></span></p>
		<div class="mlist_con">
